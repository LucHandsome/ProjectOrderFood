    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.status === 'OK') {
                const driverId = response.data.driverId; // Ensure this matches your server response
                navigate("/driverhome", { state: { driverId } });
            } else {
        ...
        <div className="flex flex-col md:flex-row h-screen">
            <div className="md:flex-1 bg-orange-500 flex items-center justify-center p-4 md:p-0">
                <div className="text-white text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold">Driver</h1>
                    <p className="mt-4 text-sm md:text-base">Nền tảng dành cho tài xế</p>
                </div>
            </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-4 text-center">
                            <p className="text-gray-700">
                                ...
                                <a className="font-bold text-blue-500 hover:text-blue-800" href="/registerDriver">
                                    Đăng ký ngay
                                </a>
                            </p>
                        </div>
